...
module.exports = function(data){
	...
	try{
		...
		try{
			...
			if((data.snakes[config.snake.id].health > 50 || data.snakes[config.snake.id].coords.length > data.snakes[data.longestSnake].coords.length - 3) && (data.snakes[config.snake.id].health > 30))
